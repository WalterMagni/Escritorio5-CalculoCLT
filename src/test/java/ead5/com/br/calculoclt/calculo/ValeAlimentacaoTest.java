...
import ead5.com.br.calculoclt.calculo.ValeAlimentacao;
...
public class ValeAlimentacaoTest {
	...
	public void testar22DiasCerto() {
		...
		CalculoBase calculo = new ValeAlimentacao(salario, valor, 5);
	...
	public void testar26DiasCerto() {
		...
		CalculoBase calculo = new ValeAlimentacao(salario, valor, 6);
	...
	public void testar15DiasCerto() {
		...
		CalculoBase calculo = new ValeAlimentacao(salario, valor, 15);
